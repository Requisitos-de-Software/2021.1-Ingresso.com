...
## 4. Especialização dos Casos de Uso
### UC01 Login
<center>

|UC01|Informações|
|--|--|
|Descrição| O [usuário](../../modelagem/lexicos/#usuario) pode fazer login no app|
...
|UC02|Informações|
|--|--|
|Descrição| O [usuário](../../modelagem/lexicos/#usuario) pode se cadastrar no aplicativo|
|Ator| [Usuário](../../modelagem/lexicos/#usuario)|
