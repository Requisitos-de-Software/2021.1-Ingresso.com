...
<p style="text-align: justify; text-indent: 20px"><b>Personas</b> conforme descrito por Cooper <i>et al.</i> (2007), Pruitt e Adlin (2006) e Cooper (1999), são personagens fictícios de um grupo de usuários reais utilizadas para descrever um usuário comum da aplicação. Através dessa técnica, as discussões de design se mantem focadas nos mesmos alvos, permitindo uma melhor análise de requisitos. Portanto, segundo Diniz <i>et al.</i> (2021, pág. 153) [1], as personas são definidas segundo seus objetivos após vários processos de refinação.</p>

## 3. Resultados
### 3.1 Persona 1
|<b>Persona Primária</b>|Regiane de Moura Silva|
|--|--|
|<b>Foto:</b>|<p style="text-align: center"><img src="../../assets/personas/regianne_moura.png" width="500px"></p><p style="text-align: center">Figura 1: Foto de Regianne</p><p style="text-align: center">Fonte: This Person Does Not Exist [2]</p>|
|<b>Idade:</b>|24 anos.|
...
|-----------------------|----------------------|
|<b>Foto:</b>|<p style="text-align: center"><img src="../../assets/personas/alice_severiano.png" width="600px"></p><p style="text-align: center">Figura 2: Foto de Alice</p><p style="text-align: center">Fonte: This Person Does Not Exist [2]</p>|
|<b>Idade:</b>|46 anos.|
...
|-----------------------|----------------------|
|<b>Foto:</b>|<p style="text-align: center"><img src="../../assets/personas/rodrigo_pereira.png" width="600px"></p><p style="text-align: center">Figura 3: Foto de Rodrigo</p><p style="text-align: center">Fonte: This Person Does Not Exist [2]</p>|
|<b>Idade:</b>|49 anos.|
